...
<html lang="en-US" dir="ltr">
  ...
  <body>
            ...
            <div class="col-12 col-xxl-6">
                <div class="card shadow-none border border-300 my-4" data-component-card="data-component-card">
                    ...
                    <div class="card-body pt-4 pb-0">
                        <form class="needs-validation" id="wizardValidationMainForm" method="POST" action="YOUR_SERVER_ENDPOINT" novalidate="novalidate">
                            <div class="tab-content">
                                ...
                                <div class="row g-3 mb-3">
                                  ...
                                  <div class="col-md-4 col-sm-6 d-flex align-items-center">
                                      <div>
                                          ...
                                          <script>
                                              document.getElementById("presetMarkets").addEventListener("change", function() {
                                                  document.getElementById("inputAddress").value = this.value;
                                              });
                                          </script>
                                      </div>
                                  </div>
                              ...
                              <div class="row g-3 mb-3">
                                  ...
                                  <div class="col-md-6">
                                      ...
                                      <input class="form-control" type="text" placeholder="Solana Public Address" required="required"/>
                                  </div>
                              </div>
                              <div class="row g-3 mb-3">
                                  <div class="col-md-6">
                                          <label class="form-label text-900">Open Orders Account</label>
                                          <input class="form-control" type="text" placeholder="Open Orders Account" required="required" />
                                  </div>
                                  <div class="col-md-6">
                                          <label class="form-label text-900">Quote Wallet</label>
                                          <input class="form-control" type="text" placeholder="Quote Wallet" required="required" />
                                  </div>
                              </div>
                        </div>
                        <div class="tab-pane" role="tabpanel" aria-labelledby="bootstrap-wizard-validation-tab2" id="bootstrap-wizard-validation-tab2">
                              <div class="row mb-3">
                                  <div class="col-md-4">
                                      <div class="form-check option-box text-center p-3 border rounded">
                                          <i data-feather="zap" class="mb-2" style="width: 36px; height: 36px;"></i>
                                          <input class="form-check-input d-none" type="radio" name="marketOption" id="inlineRadio1" value="Jupiter Surge" checked>
                                  ...
                                  <div class="col-md-4">
                                      <div class="form-check option-box text-center p-3 border rounded">
                                          ...
                                          <input class="form-check-input d-none" type="radio" name="marketOption" id="inlineRadio2" value="ETH/USDC">
                                  ...
                                  <div class="col-md-4">
                                      <div class="form-check option-box text-center p-3 border rounded">
                                          ...
                                          <input class="form-check-input d-none" type="radio" name="marketOption" id="inlineRadio3" value="WBTC/USDC">
                              ...
                              <div class="col-md-12 mt-3">
                                  <div class="row">
                                      ...
                                      <div class="col-md-4">
                                          ...
                                          <input type="number" class="form-control" required="required" placeholder="Enter your Spread Size">
                                      </div>
                                      <!-- Text Input 2 -->
                                      <div class="col-md-4">
                                          <label class="form-label">Bid Size</label>
                                          <input type="number" class="form-control" required="required" placeholder="Enter your Bid Size">
                                      </div>
                                      <!-- Text Input 3 -->
                                      <div class="col-md-4">
                                          <label class="form-label">Ask Size</label>
                                          <input type="number" class="form-control" required="required" placeholder="Enter your Ask Size">
                                      </div>
                                  </div>
                              </div>
                        </div>
                          ...
                          <div class="col-12 col-sm-auto">
                              <div class="text-center text-sm-start">
                                <h5 class="mb-3">You are all set!</h5>
                                  <p class="text-1100 fs--1">Now you can access your Bot<br />anytime anywhere</p>
    ...
    <script>
        ...
        // Script for auto-filling form inputs
        function autoFill() {
            $("#autoFillButton").prop('disabled', true);
            var marketId = $("#inputAddress").val();

            $.get('/getAccountsByMarket/' + marketId, function(data, textStatus, jqXHR) {
