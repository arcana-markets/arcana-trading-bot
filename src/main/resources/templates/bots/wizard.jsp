  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <div class="content">
        ...
        <p class="text-700 lead mb-2">Follow the Wizard to create your new Arcana trading bots</p>
        <div class="row mb-9">
              ...
              <div class="card-header p-4 border-bottom border-300 bg-soft">
                <div class="row g-3 justify-content-between align-items-center">
                  <div class="col-12 col-md">
                    <h4 class="text-900 mb-0" data-anchor="data-anchor">Create New Bot</h4>
                  </div>
                </div>
              </div>
              <div class="card-body p-0">
                  ...
                  <div class="card theme-wizard mb-5" data-theme-wizard="data-theme-wizard">
                    <div class="card-header bg-100 pt-3 pb-2 border-bottom-0">
                      <ul class="nav justify-content-between nav-wizard">
                        ...
                        <li class="nav-item"><a class="nav-link fw-semi-bold" href="#bootstrap-wizard-validation-tab3" data-bs-toggle="tab" data-wizard-step="3">
                            <div class="text-center d-inline-block"><span class="nav-item-circle-parent"><span class="nav-item-circle"><img src="/static/img/bootstrap-icons/person-badge.svg" alt="Person Badge" ...></span></span></span><span class="d-none d-md-block mt-1 fs--1">Personalize</span></div>
                          </a></li>
                        <li class="nav-item"><a class="nav-link fw-semi-bold" href="#bootstrap-wizard-validation-tab4" data-bs-toggle="tab" data-wizard-step="4">
                            <div class="text-center d-inline-block"><span class="nav-item-circle-parent"><span class="nav-item-circle"><span class="fas fa-check"></span></span></span><span class="d-none d-md-block mt-1 fs--1">Done</span></div>
                          </a></li>
                    ...
                    <div class="card-body pt-4 pb-0">
                      <div class="tab-content">
                        <div class="tab-pane active" role="tabpanel" aria-labelledby="bootstrap-wizard-validation-tab1" id="bootstrap-wizard-validation-tab1">
                          <form class="needs-validation" id="wizardValidationForm1" novalidate="novalidate" data-wizard-form="1">
                            <div class="mb-2">
                              <label class="form-label" for="bootstrap-wizard-validation-gender">Markets</label>
                              <select class="form-select" name="presetMarkets" id="presetMarkets" required="required">
                        ...
                        $("#presetMarkets").on('change', function() {
                            ...
                            <div class="form-row mb-2">
                              <div class="form-group col-md-12">
                                <input class="form-control btn btn-secondary" type="button" id="autoFillButton" value="Autofill accounts (0-30 seconds)"
                                       onclick="autoFill()"/>
                                <script>
                        function autoFill() {
                            ...
                            <div class="row g-3 mb-3">
                              <div class="col-sm-6">
                                <div class="mb-2 mb-sm-0">
                                  <label class="form-label text-900" for="bootstrap-wizard-validation-wizard-password">Open Orders Account</label>
                                  <input class="form-control" type="password" name="password" placeholder="Open Orders Account" required="required" id="bootstrap-wizard-validation-wizard-password" data-wizard-password="true" />
                                  <div class="invalid-feedback">Fill your Open Orders Account</div>
                                </div>
                              </div>
                              <div class="col-sm-6">
                                <div class="mb-2">
                                  <label class="form-label text-900" for="bootstrap-wizard-validation-wizard-confirm-password">Base Wallet Account</label>
                                  <input class="form-control" type="password" name="confirmPassword" placeholder="Base Wallet Account" required="required" id="bootstrap-wizard-validation-wizard-confirm-password" data-wizard-confirm-password="true" />
                                  <div class="invalid-feedback">Fill your Base Wallet</div>
                                </div>
                              </div>
                            </div>
                            <div class="col-sm-6">
                              <div class="mb-2">
                                <label class="form-label text-900" for="bootstrap-wizard-validation-wizard-confirm-password">Quote Wallet Account</label>
                                <input class="form-control" type="password" name="confirmPassword" placeholder="Quote Wallet" required="required" data-wizard-confirm-password="true" />
                                <div class="invalid-feedback">Fill your Quote Wallet</div>
                              </div>
                            </div>
                          </form>
                        </div>
                        <div class="tab-pane" role="tabpanel" aria-labelledby="bootstrap-wizard-validation-tab2" id="bootstrap-wizard-validation-tab2">
                          <form class="needs-validation" id="wizardValidationForm2" novalidate="novalidate" data-wizard-form="2">
                            <div class="mb-2">
                              <label class="form-label" for="bootstrap-wizard-validation-gender">Strategy</label>
                              <select class="form-select" name="gender" id="bootstrap-wizard-validation-gender" required="required">
                            ...
                            <div class="mb-2">
                              <label class="form-label" for="bootstrap-wizard-validation-wizard-phone">Bid Amount</label>
                              <input class="form-control" type="text" name="phone" placeholder="Bid" id="bootstrap-wizard-validation-wizard-phone" required="required" />
                              <div class="invalid-feedback">This field is required.</div>
                            </div>
                            <div class="mb-2">
                              <label class="form-label" for="bootstrap-wizard-validation-wizard-phone">Ask Amount</label>
                              <input class="form-control" type="text" placeholder="" required="required" id="bootstrap-wizard-validation-wizard-datepicker" />
                              <div class="invalid-feedback">This field is required.</div>
                            </div>
                          </form>
                        </div>
                        <div class="tab-pane" role="tabpanel" aria-labelledby="bootstrap-wizard-validation-tab3" id="bootstrap-wizard-validation-tab3">
                          <form class="mb-2 needs-validation" id="wizardValidationForm3" novalidate="novalidate" data-wizard-form="3">
                            <div class="row g-4 mb-4" data-dropzone="data-dropzone" data-options='{"maxFiles":1,"data":[{"name":"avatar.webp","size":"54kb","url":"/static/img/team"}]}'>
                              <div class="fallback">
                                <input type="file" name="file" />
                              </div>
                              <div class="col-md-auto">
                                <div class="dz-preview dz-preview-single">
                                  <div class="dz-preview-cover d-flex align-items-center justify-content-center mb-2 mb-md-0">
                                    <div class="avatar avatar-4xl"><img class="rounded-circle avatar-placeholder" src="/static/img/team/avatar.webp" alt="..." data-dz-thumbnail="data-dz-thumbnail" /></div>
                                    <div class="dz-progress"><span class="dz-upload" data-dz-uploadprogress=""></span></div>
                                  </div>
                                </div>
                              </div>
                              <div class="col-md">
                                <div class="dz-message dropzone-area px-2 py-3" data-dz-message="data-dz-message">
                                  <div class="text-center text-1100">
                                    <h5 class="mb-2"><span class="fa-solid fa-upload me-2"></span>Upload a Bot Profile Picture</h5>
                                    <p class="mb-0 fs--1 text-600 lh-sm">Upload a 300x300 jpg image with <br />a maximum size of 400KB</p>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class="row gx-3 gy-2">
                              <div class="col-6">
                                <label class="form-label" for="bootstrap-wizard-validation-card-name">Bot Name (Optional)</label>
                                <input class="form-control" placeholder="BagCrusher69" name="cardName" type="text" id="bootstrap-wizard-validation-card-name"/>
                              </div>
                              <div class="col-6">
                              </div>
                            </div>
                        ...
                        <div class="tab-pane" role="tabpanel" aria-labelledby="bootstrap-wizard-validation-tab4" id="bootstrap-wizard-validation-tab4">
                          ...
                          <div class="col-12 col-sm-auto">
                              <div class="text-center text-sm-start">
                                <h5 class="mb-3">You are all set!</h5>
                                <p class="text-1100 fs--1">Now you can access your Bot<br />anytime anywhere</p><a class="btn btn-primary px-6" href="/modules/forms/wizard.html">Launch Bot</a>
                              </div>
                            </div>
                            <div class="col-12 col-sm-auto">
                              <div class="text-end text-sm-end"><img class="d-dark-none" src="/static/img/spot-illustrations/arcana-finales.webp" alt="" width="250" /><img class="d-light-none" src="/static/img/spot-illustrations/arcana-finales.webp" alt="" width="250" /></div>
                            </div>
                          </div>
                        </div>
                      </div>
