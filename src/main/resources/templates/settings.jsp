            ...
            <div class="col-12 col-xl-6">
              <div class="card mb-5">
                <div class="card-header hover-actions-trigger position-relative mb-6" style="min-height: 130px; ">
                  <div class="bg-holder rounded-top" style="background-image: linear-gradient(0deg, #000000 -3%, rgba(0, 0, 0, 0) 83%), url(/static/img/banners/profile-banner.png)">
                  ...
                  <label class="avatar avatar-4xl status-online feed-avatar-profile cursor-pointer" for="upload-settings-profile-picture"><img class="rounded-circle img-thumbnail bg-white shadow-sm" src="/static/img/team/kiz.png" width="200" alt="" /></label>
                </div>
                <div class="card-body">
                  <div class="row">
                    <div class="col-12">
